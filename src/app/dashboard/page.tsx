...
export default function DashboardPage() {
    ...
    const { isActive: isOnboardingActive, isLoading: isOnboardingLoading } = useOnboarding();
    ...
    useEffect(() => {
        ...
        if (!isOnboardingLoading && isOnboardingActive) {
            router.push('/setup');
        }
    }, [isOnboardingActive, isOnboardingLoading, router]);
